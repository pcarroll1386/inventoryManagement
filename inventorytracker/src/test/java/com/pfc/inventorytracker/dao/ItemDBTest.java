...
import org.junit.jupiter.api.BeforeAll;import static org.junit.Assert.assertEquals;
...
public class ItemDBTest {
    ...
    public void testGetAllItemsForLocation() {
        ...
        List<Item> fromDao = itemDao.getAllItemsForLocation(location);
    ...
    public void testGetAllItemsByRequest() {
        ...
        List<Item> fromDao = itemDao.getAllItemsByRequest(request);
